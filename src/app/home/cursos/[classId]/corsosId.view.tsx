...
import { LeaftTab } from "./components/left-tab"
import { ButtonTabs } from "./components/rigthTabs/ButtonTabs"
import { AllTabs } from "./components/rigthTabs/Tabs"
import { useCursosIdModel } from "./cursosId.model"
import { FunctionsComponents } from "./functions-components/functions"

type CourseClientViewProps = ReturnType<typeof useCursosIdModel>

export default function CourseClientView(props: CourseClientViewProps) {
    const {
        activeTab, setActiveTab,
        control, setControl,
        forumSearch, setForumSearch,
        newNote, setNewNote,
        newNoteTitle, setNewNoteTitle,
        notes,
        selectedObject,
        selectedObjectType,
        messageToInstructor, setMessageToInstructor,
        calculateProgress, getContentType, handleAddNote, handleClick, handleSendMessage,
        isError, isLoading, isLoadingObjectData, isLoadingObjects, isLoggedUserTeacher,
        course, objects
    } = props
